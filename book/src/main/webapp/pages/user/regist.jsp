...
<!--		<link type="text/css" rel="stylesheet" href="../../static/css/style.css" >-->
		<link type="text/css" rel="stylesheet" href="./static/css/style.css" >
<!--		<script type="text/javascript" src="../../static/script/jquery-3.6.3.js"></script>-->
		<script type="text/javascript" src="./static/script/jquery-3.6.3.js"></script>
						...
						<div class="login_box">
							...
							<div class="form">
								<form action="register" method="post">
									<label>用户名称：</label>
									<input class="itxt" type="text" placeholder="5到12位字母，数字或下划线"
										   autocomplete="off" tabindex="1" name="username" id="username" />
									<br />
									<br />
									<label>用户密码：</label>
									<input class="itxt" type="password" placeholder="5到12位字母，数字或下划线"
